<div class="sm:px-16 px-6 relative flex items-start justify-center overflow-hidden bg-[#34445d]/5">
		...
		<div class="w-full block flex flex-row justify-between w-auto bg-[#34445D] py-1.5 px-3 z-10">
			...
			<div class="*:text-xs *:text-white *:italic flex justify-start items-center">
				...
				<div class="*:text-xs *:text-white *:italic *:ml-1.5 flex justify-start">
					<a href="{$config.youtube}" ><img src="/templates/{$template}/images/youtube.svg" class="w-3.5"/></a>
					<a href="{$config.facebook}" ><img src="/templates/{$template}/images/facebook.svg" class="w-3.5"/></a>
					<a href="{$config.instagram}" ><img src="/templates/{$template}/images/instagram.svg" class="w-3.5"/></a>
					<a href="{$config.vk}" ><img src="/templates/{$template}/images/vk.svg" class="w-3.5"/></a>
				</div>
			</div>
		</div>
		...
		<nav class="flex items-center justify-between flex-wrap py-4 border-b border-[#34445C] z-10">
			<div class="w-full flex justify-start flex-wrap">
				<div class="grow-0 max-sm:w-4/12">
					<a href="/" ><img src="/templates/{$template}/images/logo_243c5a.svg"/></a>
				</div>
