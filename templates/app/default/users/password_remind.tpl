                ...
                {else}
                    ...
                    <div class="m-7">
                        ...
                        <div class="flex p-4 mb-4 border-t-4 border-red-700 text-red-700 bg-red-100" role="alert">
                            <div class="ml-3 text-sm font-medium">{if $error == 'user_not_found'}Пользователь не найден
                        ...
                        {if $password_send}
                            <div class="flex p-4 mb-4 border-t-4 border-green-700 text-green-700 bg-green-100" role="alert">
                                <div class="ml-3 text-sm font-medium">На {$email|escape} отправлено письмо для восстановления пароля.</div>
                            </div>
                        {/if}
                        ...
                        <form action="/users/forgot/" method="post">
                            ...
                            <div class="flex flex-wrap mb-3">
                                <div class="w-full mb-3 md:pr-1">
                                    ...
                                    <input class="appearance-none block w-full bg-white text-[#34445d] border border-[#34445D]/20 rounded py-3 px-4 focus:outline-none focus:bg-white focus:border-[#34445d] text-xs" value="{if isset($email)}{$email|escape}{/if}" id="email" name="email" type="text" placeholder="Укажите email" required>
                                </div>
