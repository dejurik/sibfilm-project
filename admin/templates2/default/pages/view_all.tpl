                    ...
                    {foreach from=$view_all key=key item=item}
                        <tr class="bg-white border-b border-dashed">
                            ...
                            <td class="p-3 text-sm text-gray-500 whitespace-nowrap text-right">
                                ...
                                <a href="#" class="delete inline-flex items-center px-2 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md" data-id="{$item.id_item}" data-url="/admin/?mod=pages&act=view_all" data-title="{$item.title}">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
