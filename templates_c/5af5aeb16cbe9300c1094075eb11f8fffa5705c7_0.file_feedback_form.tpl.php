...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.0.2',
  'unifunc' => 'content_662655f2e8ed76_16907613',
...
function content_662655f2e8ed76_16907613 (\Smarty\Template $_smarty_tpl) {
    ...
    <div class="*:text-[#34445d] py-2 mx-12">
        ...
        <form action="" method="post" id="form_feedback" onsubmit="event.preventDefault()">
            ...
            <div class="flex flex-wrap mb-6">
                <div class="w-full md:w-1/3 mb-6 md:mb-0 md:pr-1">
                    <label class="block text-[#34445d] text-xs font-bold mb-2" for="name">Ваше имя</label>
                    <input class="appearance-none block w-full bg-white text-[#34445d] border border-[#34445D]/20 rounded py-3 px-4 mb-3 focus:outline-none focus:bg-white" id="name" type="text" placeholder="Ваше имя" name="name">
                </div>
                <div class="w-full md:w-1/3 mb-6 md:pl-1">
                    <label class="block text-[#34445d] text-xs font-bold mb-2" for="phone">Телефон</label>
                    <input class="appearance-none block w-full bg-white text-[#34445d] border border-[#34445D]/20 rounded py-3 px-4 focus:outline-none focus:bg-white focus:border-[#34445d]" id="phone" name="phone" type="text" placeholder="Укажите телефон">
                </div>
                <div class="w-full md:w-1/3 mb-6 md:pl-1">
                    <label class="block text-[#34445d] text-xs font-bold mb-2" for="email">Email</label>
                    <input class="appearance-none block w-full bg-white text-[#34445d] border border-[#34445D]/20 rounded py-3 px-4 focus:outline-none focus:bg-white focus:border-[#34445d]" id="email" name="email" type="text" placeholder="Укажите email">
                </div>
            </div>
            <div class="flex flex-wrap mb-6">
                <div class="w-full">
