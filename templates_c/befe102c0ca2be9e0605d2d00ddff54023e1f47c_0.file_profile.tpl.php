<?php
/* Smarty version 5.0.2, created on 2024-06-08 20:33:24
  from 'file:[main]/default/users/profile.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.0.2',
  'unifunc' => 'content_666495e4cd39a9_64989387',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'befe102c0ca2be9e0605d2d00ddff54023e1f47c' => 
    array (
      0 => '[main]/default/users/profile.tpl',
      1 => 1717868001,
      2 => 'file',
    ),
  ),
...
function content_666495e4cd39a9_64989387 (\Smarty\Template $_smarty_tpl) {
...
" alt="" class="absolute top-0 right-0 w-24 h-24
                    rounded-tl rounded-tr-[20%] rounded-bl-[20%] rounded-br mx-auto block">
                    <div class="text-xl font-bold no-underline max-md:text-base"><?php echo $_smarty_tpl->getValue('view')['name'];?>
</div>
                    ...
                    <div class="flex items-center mt-8 space-x-2 text-dark-600 dark:text-gray-400">
                        ...
                        <a href="mailto:<?php echo $_smarty_tpl->getValue('view')['email'];?>
" class="text-sm"><?php echo $_smarty_tpl->getValue('view')['email'];?>
</a>
                    </div>
                    ...
                    <div class="flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400">
                        ...
                        <a href="tel:<?php echo $_smarty_tpl->getValue('view')['phone'];?>
" class="text-sm"><?php echo $_smarty_tpl->getValue('view')['phone'];?>
</a>
                    </div>
                    ...
                    <div class="flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400">
                        ...
                        <a href="<?php echo $_smarty_tpl->getValue('view')['site'];?>
" class="text-sm"><?php echo $_smarty_tpl->getValue('view')['site'];?>
</a>
                    </div>
                    <div class="flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                        ...
                        <span class="text-sm"><?php echo $_smarty_tpl->getValue('view')['role_id'];?>
</span>
                    </div>
                    <div class="hidden lg:block pt-2">
                        <div class="text-sm"><?php echo $_smarty_tpl->getValue('view')['about'];?>
</div>
                    </div>
                ...
                <div class="*:text-[#34445d] m-7">
                    <?php if ($_smarty_tpl->getValue('error')) {?>
                        <div class="flex p-4 mb-4 border-t-4 border-red-700 text-red-700 bg-red-100" role="alert">
                            <div class="ml-3 text-sm font-medium"><?php if ($_smarty_tpl->getValue('error') == 'confirm_password_error') {?>Пароль не обнолен, нет подтверждения
                                <?php } elseif ($_smarty_tpl->getValue('error') == 'email_error') {?>Этот Email использовать нельзя
                                <?php } else {
echo $_smarty_tpl->getValue('error');
                    ...
                    <?php if ($_smarty_tpl->getValue('success')) {?>
                        <div class="flex p-4 mb-4 border-t-4 border-green-700 text-green-700 bg-green-100" role="alert">
                            <div class="ml-3 text-sm font-medium"><?php echo $_smarty_tpl->getValue('success');?>
</div>
                        </div>
                    <?php }?>
...
">
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-2">
                            <div class="col-span-5">
                                ...
                                <input value="<?php echo $_smarty_tpl->getValue('view')['name'];?>
" class="appearance-none block w-full bg-white text-[#34445d] border border-[#34445D]/20 rounded py-3 px-4 focus:outline-none focus:bg-white focus:border-[#34445d] text-xs" id="name" name="name" type="text" placeholder="Укажите имя" required>
                            </div>
                            <div class="col-span-5">
                                <label class="block text-[#34445d] text-xs font-bold mb-2" for="email">Email</label>
                                <input value="<?php echo $_smarty_tpl->getValue('view')['email'];?>
" class="appearance-none block w-full bg-white text-[#34445d] border border-[#34445D]/20 rounded py-3 px-4 focus:outline-none focus:bg-white focus:border-[#34445d] text-xs" id="email" name="email" type="text" placeholder="Укажите email" required>
                            </div>
                            <div class="col-span-2 row-span-3">
                                <label class="block text-[#34445d] text-xs font-bold mb-2" for="email">Аватар</label>

                                <div class="group relative pr-2.5">
                                    <img class="rounded-tl rounded-tr-[20%] rounded-bl-[20%] rounded-br w-24 h-24" src="<?php echo $_smarty_tpl->getValue('view')['avatar'];?>
" />
                                    <input name="old_avatar" type="hidden" value="<?php echo $_smarty_tpl->getValue('view')['avatar'];?>
">
                            ...
                            <div class="col-span-5">
                                ...
                                <input value="<?php echo $_smarty_tpl->getValue('view')['phone'];?>
" class="appearance-none block w-full bg-white text-[#34445d] border border-[#34445D]/20 rounded py-3 px-4 focus:outline-none focus:bg-white focus:border-[#34445d] text-xs" name="phone" type="text" placeholder="Телефон">
                            </div>
                            <div class="col-span-5">
                                <label class="block text-[#34445d] text-xs font-bold mb-2" for="name">Сайт</label>
                                <input value="<?php echo $_smarty_tpl->getValue('view')['site'];?>
" class="appearance-none block w-full bg-white text-[#34445d] border border-[#34445D]/20 rounded py-3 px-4 focus:outline-none focus:bg-white focus:border-[#34445d] text-xs" name="site"  type="text" placeholder="Сайт">
                            </div>
                            <div class="col-span-12">
                                <label class="block text-[#34445d] text-xs font-bold mb-2" for="name">Обо мне</label>
                                <textarea class="appearance-none block w-full bg-white text-[#34445d] border border-[#34445D]/20 rounded py-3 px-4 focus:outline-none focus:bg-white focus:border-[#34445d] text-xs" placeholder="Обо мне" name="about"><?php echo $_smarty_tpl->getValue('view')['about'];?>
</textarea>
                            </div>
