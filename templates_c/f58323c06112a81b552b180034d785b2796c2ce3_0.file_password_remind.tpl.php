<?php
/* Smarty version 5.0.2, created on 2024-06-06 17:43:07
  from 'file:[main]/default/users/password_remind.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.0.2',
  'unifunc' => 'content_6661cafb9b2bb1_68392957',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f58323c06112a81b552b180034d785b2796c2ce3' => 
    array (
      0 => '[main]/default/users/password_remind.tpl',
      1 => 1717684974,
      2 => 'file',
    ),
  ),
...
function content_6661cafb9b2bb1_68392957 (\Smarty\Template $_smarty_tpl) {
                ...
                <?php } else { ?>
                    ...
                    <div class="m-7">
                        ...
                        <div class="flex p-4 mb-4 border-t-4 border-red-700 text-red-700 bg-red-100" role="alert">
                            <div class="ml-3 text-sm font-medium"><?php if ($_smarty_tpl->getValue('error') == 'user_not_found') {?>Пользователь не найден
                                <?php } elseif ($_smarty_tpl->getValue('error') == 'captcha') {?>Неверно введена капча
                                <?php } else {
echo $_smarty_tpl->getValue('error');
                        ...
                        <?php }?>
                        <?php if ($_smarty_tpl->getValue('password_send')) {?>
                            <div class="flex p-4 mb-4 border-t-4 border-green-700 text-green-700 bg-green-100" role="alert">
                                <div class="ml-3 text-sm font-medium">На <?php echo htmlspecialchars((string)$_smarty_tpl->getValue('email'), ENT_QUOTES, 'UTF-8', true);?>
 отправлено письмо для восстановления пароля.</div>
                            </div>
                        <?php }?>

                        <div class="text-2xl font-bold no-underline max-md:text-base text-[#34445d]">Востановление доступа:</div>
                        <div class="text-sm hidden lg:block pt-2 text-[#34445d]">Напоминание пароля:</div>
                    </div>
...
">
                            <div class="flex flex-wrap mb-3">
                                <div class="w-full mb-3 md:pr-1">
                                    ...
                                    <input class="appearance-none block w-full bg-white text-[#34445d] border border-[#34445D]/20 rounded py-3 px-4 focus:outline-none focus:bg-white focus:border-[#34445d] text-xs" value="<?php if ((null !== ($_smarty_tpl->getValue('email') ?? null))) {
echo htmlspecialchars((string)$_smarty_tpl->getValue('email'), ENT_QUOTES, 'UTF-8', true);
}?>" id="email" name="email" type="text" placeholder="Укажите email" required>
                                </div>
                                ...
                                <div class="w-full md:w-3/12 mb-3 md:pr-1">
                                    <label class="block text-[#34445d] text-xs font-bold mb-2">&nbsp;</label>
                                    <button class="float-right disabled:opacity-30 block text-sm border rounded-full text-[#34445C] border-[#34445C] px-4 py-2 hover:border-transparent hover:text-white hover:bg-[#34445C]" type="submit">
                                        Вспомнить
                                    </button>
                                </div>
                            </div>
