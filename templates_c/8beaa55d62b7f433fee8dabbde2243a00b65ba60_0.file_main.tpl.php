<?php
/* Smarty version 5.0.2, created on 2024-03-31 11:49:45
  from 'file:[0]/default/main.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.0.2',
  'unifunc' => 'content_660923a9a889f2_68556157',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8beaa55d62b7f433fee8dabbde2243a00b65ba60' => 
    array (
      0 => '[0]/default/main.tpl',
      1 => 1711650690,
      2 => 'file',
    ),
  ),
...
function content_660923a9a889f2_68556157 (\Smarty\Template $_smarty_tpl) {
...
<?php $_smarty_tpl->renderSubTemplate("file:default/sliders/index_sliders.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('sliders'=>$_smarty_tpl->getValue('sliders')), (int) 0, $_smarty_current_dir);
?>
        ...
        <div class="flex flex-row w-full block w-auto bg-[#F3F3F3]/20 mb-8">
            ...
            <div class="basis-2/3 mr-4">
                ...
                <a href="./projects.html" class="">
                    <div class="bg-[#34445d] h-80 rounded-lg mb-4 relative block bg-[url('../src/images/projects.jpg')] bg-right bg-no-repeat max-md:bg-none">
                ...
                <a href="#" class="">
                    <div class="bg-[#f3f3f1] h-56 rounded-lg relative block bg-[url('../src/images/partners.jpg')] bg-right bg-no-repeat max-md:bg-none">
            ...
            <div class="basis-1/3">
                ...
                <a href="./services.html" class="">
                    <div class="bg-[#f3f3f1] h-56 rounded-lg mb-4 relative block bg-[url('../src/images/services.jpg')] bg-right bg-no-repeat max-md:bg-none ">
                        <div class="absolute bottom-7 left-7 *:text-[#7B8384]">
                ...
                <a href="#" class="">
                    <div class="bg-[#34445d] h-80 rounded-lg relative block bg-[url('../src/images/presents.jpg')] bg-right bg-no-repeat max-md:bg-none">
                        <div class="absolute bottom-7 left-7 *:text-white">
