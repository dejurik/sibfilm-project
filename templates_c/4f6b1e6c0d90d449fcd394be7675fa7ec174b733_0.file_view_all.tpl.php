<?php
/* Smarty version 5.0.2, created on 2024-07-03 15:17:04
  from 'file:templates/admin/features/view_all.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.0.2',
  'unifunc' => 'content_66854140b39ca4_35242430',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4f6b1e6c0d90d449fcd394be7675fa7ec174b733' => 
    array (
      0 => 'templates/admin/features/view_all.tpl',
      1 => 1718886421,
      2 => 'file',
    ),
  ),
...
function content_66854140b39ca4_35242430 (\Smarty\Template $_smarty_tpl) {
...
?>
                        <tr class="bg-white border-b border-dashed">
                            <td class="p-3 text-sm font-medium whitespace-nowrap">
                                <a href="/admin/?mod=features&act=option&id=<?php echo $_smarty_tpl->getValue('item')['id_item'];?>
" class="text-blue-500"><?php echo $_smarty_tpl->getValue('item')['title'];?>
</a>
                            </td>
                            <td class="p-3 text-sm text-gray-500 whitespace-nowrap">
                                <?php if ($_smarty_tpl->getValue('item')['module_id'] == 'projects') {?>Проекты<?php } elseif ($_smarty_tpl->getValue('item')['module_id'] == 'shop') {?>Магазин<?php }?>
                            </td>
...
"  data-action="delete" data-url="/admin/?mod=features&act=view_all" data-title="<?php echo $_smarty_tpl->getValue('item')['title'];?>
">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
