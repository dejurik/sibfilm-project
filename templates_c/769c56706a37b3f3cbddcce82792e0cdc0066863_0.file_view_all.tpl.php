<?php
/* Smarty version 5.0.2, created on 2024-05-04 23:10:52
  from 'file:templates/admin/projects/view_all.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.0.2',
  'unifunc' => 'content_6636964cee3878_12988716',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '769c56706a37b3f3cbddcce82792e0cdc0066863' => 
    array (
      0 => 'templates/admin/projects/view_all.tpl',
      1 => 1714853435,
      2 => 'file',
    ),
  ),
...
function content_6636964cee3878_12988716 (\Smarty\Template $_smarty_tpl) {
...
?>
                        <tr class="bg-white border-b border-dashed">
                            <td class="p-3 text-sm font-medium whitespace-nowrap">
                                <a href="/admin/?mod=projects&act=project&id=<?php echo $_smarty_tpl->getValue('item')['id_item'];?>
" class="text-blue-500"><?php echo $_smarty_tpl->getValue('item')['title'];?>
</a>
                            </td>
                            <td class="p-3 text-sm text-gray-500 whitespace-nowrap">
                                /proects/<?php echo $_smarty_tpl->getValue('item')['url'];?>
...
"  data-action="delete" data-url="/admin/?mod=projects&act=view_all" data-title="<?php echo $_smarty_tpl->getValue('item')['title'];?>
">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
            ...
            <div class="ml-4 bg-white shadow rounded-md h-full w-1/4 p-4 relative overflow-hidden">
                <table class="min-w-full">
                    ...
                    <tbody>
                        <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('staff_all'), 'item', false, 'key');
$foreach1DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('key')->value => $_smarty_tpl->getVariable('item')->value) {
...
?>
                        <tr class="bg-white border-b border-dashed">
                            <td class="p-3 text-sm font-medium whitespace-nowrap">
                                <a rel="modal:open" href="/admin/?mod=projects&act=staff&id=<?php echo $_smarty_tpl->getValue('item')['id_item'];?>
" class="text-blue-500"><?php echo $_smarty_tpl->getValue('item')['title'];?>
</a>
                            </td>
...
" class="inline-flex items-center px-2 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md">
                                ...
                                <a href="#" class="delete inline-flex items-center px-2 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md" data-id="<?php echo $_smarty_tpl->getValue('item')['id_item'];?>
"  data-action="delete_staff" data-url="/admin/?mod=projects&act=view_all" data-title="<?php echo $_smarty_tpl->getValue('item')['title'];?>
">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                                    </svg>
