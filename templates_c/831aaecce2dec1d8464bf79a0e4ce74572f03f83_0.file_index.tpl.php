<?php
/* Smarty version 5.0.2, created on 2024-03-29 16:12:00
  from 'file:[admin]/default/index.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.0.2',
  'unifunc' => 'content_6606be20bb3425_56570720',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '831aaecce2dec1d8464bf79a0e4ce74572f03f83' => 
    array (
      0 => '[admin]/default/index.tpl',
      1 => 1711717915,
      2 => 'file',
    ),
  ),
...
function content_6606be20bb3425_56570720 (\Smarty\Template $_smarty_tpl) {
					...
					<table class="min-w-full">
						...
						<tr class="bg-white border-b border-dashed">
							<td class="p-3 text-sm font-medium whitespace-nowrap">
								<a href="#" class="text-blue-500">Услуги</a>
							</td>
							<td class="p-3 text-sm text-gray-500 whitespace-nowrap">
								http://site.ru/pages/about.html
							</td>
							...
							<td class="p-3 text-sm text-gray-500 whitespace-nowrap text-right">
								...
								<a href="#" class="inline-flex items-center px-2 py-2 bg-green-500 hover:bg-green-500 text-white rounded-md">
									<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
								...
								<a href="#" class="inline-flex items-center px-2 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md">
									<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
										<path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
									</svg>
								</a>

								<a href="#" class="inline-flex items-center px-2 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md">
									<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
